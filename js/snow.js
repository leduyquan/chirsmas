...
function SnowStorm() {
  ...
  var imagePath = 'img/snow/'; // relative path to snow images (including trailing slash)
  var flakesMax = 50;
  var flakesMaxActive = 50;
  var vMaxX = 2;
  var vMaxY = 2;
  var usePNG = false;
  ...
  this.SnowFlake = function(parent,type,x,y) {
    ...
    this.o.src = imagePath+this.type+(pngSupported && usePNG?'.png':'.png');
